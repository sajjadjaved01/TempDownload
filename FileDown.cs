    ...
    public class FileDown
    {
        ...
        public void AsyncDownload(string url)
        {
            System.Threading.ThreadPool.QueueUserWorkItem(
                new System.Threading.WaitCallback(WaitCallbackMethod), new string[] { url, "" });
        }
        ...
        {
            System.Threading.ThreadPool.QueueUserWorkItem(
                new System.Threading.WaitCallback(WaitCallbackMethod), new string[] { url, destFolder });
        }
        ...
        {
            System.Threading.ThreadPool.QueueUserWorkItem(
                new System.Threading.WaitCallback(WaitCallbackMethod), new object[] { urlList, destFolder });
        }
        ...
        {
            System.Threading.ThreadPool.QueueUserWorkItem(
                new System.Threading.WaitCallback(WaitCallbackMethod), new object[] { urlList, "" });
        }
        ...
        public class DownloadEventArgs : EventArgs
        {
            ...
            public DownloadEventArgs(long totalFileSize, long currentFileSize)
            {
                ...
                percentDone = (int)((((double)currentFileSize) / totalFileSize) * 100);
            }
